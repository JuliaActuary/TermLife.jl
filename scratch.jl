...
# ╔═╡ eafa09d3-c2c5-4674-b0d4-96818c90c78b
begin
...
# ╔═╡ f050f7d9-275e-4ce7-847e-279f31a5ecb8
begin
	select_ultimates = map(MortalityTables.table, 3299:3309)
	selects = map(select_ultimates -> select_ultimates.select, select_ultimates)
	ultimates = map(select_ultimates -> select_ultimates.ultimate, select_ultimates)
	print(ndims(selects))
	print(ndims(ultimates))
end
...
[[ActuaryUtilities]]
deps = ["Dates", "Distributions", "ForwardDiff", "MuladdMacro", "QuadGK", "Roots", "SnoopPrecompile", "StatsBase", "Yields"]
git-tree-sha1 = "faee91825c027e26419a1325c52d31dd30ccf0e5"
...
git-tree-sha1 = "da13e5b351e66abf529dcde2c52edacb1c84397e"
